    ...
    <>
      <div className="container">
        <div className="card m-3" style={{ width: "18rem" }}>
          <img src={plant.Img} className="card-img-top" alt="plant img" />
          <div className="card-body">
            <h5 className="card-title">{plant["Latin name"]}</h5>
            <p className="card-text">
              <strong>Common Name:</strong> {plant["Common name"].join(", ")}
              <br />
              ...
              <br />
              <strong>Width at Purchase:</strong> {plant["Width at purchase"].M}
              m /{plant["Width at purchase"].CM}cm
              <br />
              <strong>Height Potential:</strong> {plant["Height potential"].M}m
              /{plant["Height potential"].CM}cm
              <br />
              <strong>Width Potential:</strong> {plant["Width potential"].M}m /
              {plant["Width potential"].CM}cm
              <br />
              ...
              <br />
              <strong>Temperature Min:</strong> {plant["Temperature min"].F}°F /{" "}
              {plant["Temperature min"].C}°C
              <br />
              <strong>Temperature Max:</strong> {plant["Temperature max"].F}°F /{" "}
              {plant["Temperature max"].C}°C
              <br />
              ...
              <br />
              <strong>Pot Diameter:</strong> {plant["Pot diameter (cm)"].M} m /{" "}
              {plant["Pot diameter (cm)"].CM} cm
            </p>
          </div>
        </div>
      </div>
